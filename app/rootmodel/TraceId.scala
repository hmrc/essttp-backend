...
object TraceId {
  ...
  implicit val traceIdPathBinder: PathBindable[TraceId] = utils.ValueClassBinder.valueClassBinder(_.value)
  implicit val traceIdQueryStringBinder: QueryStringBindable[TraceId] = utils.ValueClassBinder.queryStringValueBinder(_.value)
}
