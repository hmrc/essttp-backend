...
class SjController @Inject() (
  ...
  def startJourneyEpayeFromEpaye(): Action[SjRequest.Epaye.Simple] = startJourneyEpaye[SjRequest.Epaye.Simple](Origins.Epaye.EPAYE)
  ...
  private def journeyDescription(origin: Origin): String = origin match {
    case o: Origins.Epaye => o match {
      ...
      case Origins.Epaye.EPAYE       => "Journey for Epaye from EPAYE service"
