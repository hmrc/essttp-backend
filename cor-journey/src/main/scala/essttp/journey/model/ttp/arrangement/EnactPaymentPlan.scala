...
import essttp.journey.model.ttp.PaymentPlanFrequency
import essttp.journey.model.ttp.affordablequotes.{Collection, Instalment, NumberOfInstalments, PlanDuration, PlanInterest, TotalDebt, TotalDebtIncludingInterest}
