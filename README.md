...
graph TD;
    ...
    EligibilityCheck.Eligible --> AfterUpfrontPaymentDetermined.CanPayUpfront;
    EligibilityCheck.Eligible --> AfterUpfrontPaymentDetermined.CannotPayUpfront;
    AfterUpfrontPaymentDetermined.CanPayUpfront --> RetrievedExtremeDates;
    AfterUpfrontPaymentDetermined.CannotPayUpfront --> RetrievedExtremeDates;
