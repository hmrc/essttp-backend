...
class ChannelIdentifierSpec extends UnitSpec {
  ...
  "survive round trip de/serialisation" in {
    Json.toJson[ChannelIdentifier](ChannelIdentifiers.eSSTTP) shouldBe JsString("eSSTTP")
    JsString("eSSTTP").as[ChannelIdentifier] shouldBe ChannelIdentifiers.eSSTTP
  }
}
