...
trait TdJourneySaDetachedUrl {
  ...
  object SaDetachedUrl extends TdJourneyStructure {
    ...
    def journeyAfterEnteredCanYouSetUpDirectDebitNoAffordability(isAccountHolder: Boolean): Journey.AfterEnteredCanYouSetUpDirectDebit = Journey.Sa.EnteredCanYouSetUpDirectDebit(
      _id                          = dependencies.journeyId,
      origin                       = Origins.Sa.DetachedUrl,
      createdOn                    = dependencies.createdOn,
      sjRequest                    = sjRequest,
    ...
    def journeyAfterConfirmedDirectDebitDetailsNoAffordability: Journey.AfterConfirmedDirectDebitDetails = Journey.Sa.ConfirmedDirectDebitDetails(
      _id                          = dependencies.journeyId,
      origin                       = Origins.Sa.DetachedUrl,
      createdOn                    = dependencies.createdOn,
      sjRequest                    = sjRequest,
