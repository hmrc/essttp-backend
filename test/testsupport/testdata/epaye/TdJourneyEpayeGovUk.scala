...
trait TdJourneyEpayeGovUk {
  ...
  object EpayeGovUk extends TdJourneyStructure {
    ...
    def journeyAfterEnteredDetailsAboutBankAccountNoAffordability(isAccountHolder: Boolean): Journey.AfterEnteredDetailsAboutBankAccount = Journey.Epaye.EnteredDetailsAboutBankAccount(
      _id                          = dependencies.journeyId,
      origin                       = Origins.Epaye.GovUk,
      createdOn                    = dependencies.createdOn,
      sjRequest                    = sjRequest,
    ...
    override def journeyAfterConfirmedDirectDebitDetailsNoAffordability: Journey.AfterConfirmedDirectDebitDetails = Journey.Epaye.ConfirmedDirectDebitDetails(
      _id                          = dependencies.journeyId,
      origin                       = Origins.Epaye.GovUk,
      createdOn                    = dependencies.createdOn,
      sjRequest                    = sjRequest,
