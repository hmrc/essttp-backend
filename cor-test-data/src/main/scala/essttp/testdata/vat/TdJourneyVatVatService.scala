...
trait TdJourneyVatVatService {
  ...
  object VatVatService { // todo uncomment this when we are closer to finishing vat... //extends TdJourneyStructure {
    ...
    def updateDirectDebitDetailsRequestJson(): JsObject = read("/testdata/vat/vatservice/UpdateDirectDebitDetailsRequest.json").asJson
    ...
    def journeyAfterEnteredDirectDebitDetailsJson: JsObject = read("/testdata/vat/vatservice/JourneyAfterUpdateDirectDebitDetails.json").asJson

    def updateConfirmedDirectDebitDetailsRequest(): JsNull.type = JsNull

    def updateConfirmedDirectDebitDetailsJson(): JsObject = read("/testdata/vat/vatservice/UpdateConfirmedDirectDebitDetailsRequest.json").asJson
    ...
    def journeyAfterConfirmedDirectDebitDetailsJson: JsObject = read("/testdata/vat/vatservice/JourneyAfterUpdateConfirmedDirectDebitDetails.json").asJson
    ...
    def updateAgreedTermsAndConditionsJson(): JsObject = read("/testdata/vat/vatservice/UpdateAgreedTermsAndConditions.json").asJson
    ...
    def journeyAfterAgreedTermsAndConditionsJson: JsObject = read("/testdata/vat/vatservice/JourneyAfterUpdateAgreedTermsAndConditions.json").asJson

    def updateSelectedEmailRequest(): Email = dependencies.email

    def updateSelectedEmailRequestJson(): JsObject = read("/testdata/vat/vatservice/UpdateSelectedEmailRequest.json").asJson
    ...
    def journeyAfterSelectedEmailJson: JsObject = read("/testdata/vat/vatservice/JourneyAfterUpdateSelectedEmail.json").asJson

    def updateEmailVerificationStatusRequestJson(): JsObject = read("/testdata/vat/vatservice/UpdateEmailVerificationStatusRequest.json").asJson
    ...
    def journeyAfterEmailVerificationStatusJson: JsObject = read("/testdata/vat/vatservice/JourneyAfterUpdateEmailVerificationStatus.json").asJson

    def updateArrangementRequest(): ArrangementResponse = dependencies.arrangementResponseVat

    def updateArrangementRequestJson(): JsObject = read("/testdata/vat/vatservice/UpdateSubmittedArrangementRequest.json").asJson
    ...
    def journeyAfterSubmittedArrangementJson: JsObject = read("/testdata/vat/vatservice/JourneyAfterUpdateSubmittedArrangement.json").asJson
